  ...
  <div class="player" v-show="playlist.length">
          ...
          <scroll class="middle-r" ref="lyricList" :data='currentLyric && currentLyric.lines'>
            <div class="lyric-wrapper">
              <div v-if="currentLyric">
                <p class="text" :class="{'current':currentLineNum === index}" ref="lyricLine" v-for="(line,index) of currentLyric.lines" :key="index">{{line.txt}}</p>
              </div>
            </div>
          </scroll>
        </div>
        <div class="bottom">
          ...
          <div class="progress-wrapper">
            ...
            <div class="progress-bar-wrapper">
              <bar :percent='percent' @percentchange='Barchange'></bar>
            </div>
    ...
    <transition name="mini">
      <div class="mini-player" v-show="!fullScreen">
        ...
        <div class="control">
          <procircle :radius='radius' :percent='percent'>
...
export default {
  ...
  methods: {
    getLyric () {
      axios.get('/apilyric/lyric.json')
        .then(this.getLyricSucc).catch(() => {
