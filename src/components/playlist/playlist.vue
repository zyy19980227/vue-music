<template>
  <transition name="list-fade">
    <div class="playlist" v-show="showFlag" @click="hide">
      <div class="list-wrapper" @click.stop>
        ...
        <scroll class="list-content" :data='sequenceList' :refreshDelay='refreshDelay' ref="listContent">
          <transition-group name="list" tag="ul">
            <li class="item" v-for="(item,index) of sequenceList" :key="item.id" @click='selectItem(item, index)' ref="listItem">
      ...
      <confirm ref="confirm" :text="text" :confirmBtnText='confirmBtnText' @confirm='confirmClear'></confirm>
